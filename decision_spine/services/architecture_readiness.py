...
ARCHITECTURE_LAYERS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "horizontal_next_step": "Add decision-policy checks for when each stakeholder should wait, revise, escalate, or archive.",
    ...
    },
    {
        ...
        "horizontal_next_step": "Add a source freshness and owner-obligation review across planned signal domains.",
