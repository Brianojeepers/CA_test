...
ARCHITECTURE_LAYERS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "current_coverage": "Validation, unit tests, frontend checks, dashboard smoke tests, privacy gates, and known warnings are documented.",
        "current_assets": [
        ...
        "horizontal_next_step": "Add a trust registry that summarizes freshness, source coverage, privacy posture, and confidence by surface.",
